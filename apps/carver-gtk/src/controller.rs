...
use carver_sdk::{Category, CategoryId, LibraryClient, LibraryError, Note, NoteId};
...
pub(crate) struct AppState {
    pub(crate) client: LibraryClient,
...
impl AppState {
    ...
    pub(crate) fn new(client: LibraryClient, config: Config) -> Self {
...
pub(crate) fn active_category(state: &AppState) -> Result<Option<CategoryId>, LibraryError> {
...
#[cfg(test)]
pub(crate) fn create_next_category(state: &AppState) -> Result<Category, LibraryError> {
...
pub(crate) fn create_category(state: &AppState, name: &str) -> Result<Category, LibraryError> {
...
pub(crate) fn trash_current_note(state: &AppState) -> Result<bool, LibraryError> {
...
pub(crate) fn open_note(state: &AppState, note_id: NoteId) -> Result<Option<Note>, LibraryError> {
